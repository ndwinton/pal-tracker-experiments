...
@SpringBootTest(classes = PalTrackerApplication.class, webEnvironment = NONE)
public class JpaTimeEntryRepositoryTest {
    ...
    public void setUp() {
        ...
        subject = new JpaTimeEntryRepository(crudRepository);
